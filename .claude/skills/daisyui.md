...
source: https://github.com/vinnie357/claude-skills/blob/main/plugins/ui/skills/daisyui/SKILL.md
---
...
## Project-specific notes (velo-tracker)

- CDN setup: DaisyUI v4 full CSS + Tailwind CDN v3 (no build step)
  ```html
  <link href="https://cdn.jsdelivr.net/npm/daisyui@4/dist/full.min.css" rel="stylesheet">
  <script src="https://cdn.tailwindcss.com"></script>
  ```
- Theme is set dynamically based on `prefers-color-scheme`: `dim` for dark, `light` for light
- `stats` component used for key metrics on activity and route detail pages
- `badge-hard` custom class in `style.css` for RPE orange (no DaisyUI equivalent)
- Double-range slider (`.drange`) is custom CSS — no DaisyUI equivalent
- Map containers (`#map`, `#heatmap`) styled in `style.css`, not via DaisyUI
